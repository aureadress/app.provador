...
`;
    ...
    const complemento = `Você está prestes para arrasar com o <strong>${nomeProduto}</strong> no tamanho <strong>${tamanhoIdeal}</strong>! Para facilitar, liberei um cupom especial: <strong>Código do Cupom: ${cupom}</strong> — use na finalização da compra e aproveite o desconto. Corre que é por tempo limitado!`;
